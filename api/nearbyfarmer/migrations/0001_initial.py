# Generated by Django 5.0.2 on 2024-03-18 15:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sensor_data', to='nearbyfarmer.plant')),
            ],
        ),
        migrations.AddField(
            model_name='plant',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='plants', to='nearbyfarmer.user'),
        ),
    ]
